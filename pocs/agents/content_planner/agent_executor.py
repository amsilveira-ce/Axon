    ...
    async def execute(
        ...
        try:
            ...
            await updater.update_status(
                ...
                new_text_message(self.status_message, context_id=task.context_id, task_id=task.id),
            )
            ...
            await updater.update_status(
                ...
                message=new_text_message(f"Error: {e!s}", context_id=task.context_id, task_id=task.id),
            )